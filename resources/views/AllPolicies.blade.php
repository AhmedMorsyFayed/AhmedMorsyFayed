...
<br>
<br>
<!--layout for manager for see all approved policies and canceled policies -->
<br><br>
...
<table class="table table-sm table-primary">
    ...
    $policies = DB::select('select * from policies where Manager ="Approve" or Manager ="Cancel" ORDER BY id DESC');
    ...
    <tr style="background-color: #17a2b8;color: white;border: 2px solid #00002E;height: 50px!important; "><!--header  -->
        ...
        <td style="border: 2px solid #00002E;color: white;width: 150px">Status</td>
    ...
    <tr>
        ...
        <td style="border: 2px solid #00002E;">{{ $policy->serialnum }}</td>
        ...
        <td style="border: 2px solid #00002E;width: 100px">{{ $policy->Manager }}</td>
        @if($policy->Manager =="Cancel" )
        <td ><a id="pre" href='approvee/{{$policy->id }}' class="btn-primary">Approve</a></td>
        @else
            <td ></td>
        @endif
        @if(($policy->FinanceStatus =="Review")and( $policy->Cashier != null))
            <td ><a id="pre" href='printpolicy/{{$policy->id }}' class="btn-primary">Print</a></td>
        @else
            <td ></td>
        @endif
        @if($policy->FinanceStatus == null)
