...
<body>
<!--layout for employee to print approve ploicies -->
<div >
...
<center>
    <form  id="contact-form"   method="post">
        ...
        $pendingBroker =DB::select('select * from broker where status ="Approve" and User=? ORDER BY id DESC',[$name]);
        ...
        <table class="table table-sm table-primary">
            <tr style="background-color: #17a2b8;color: white;border: 2px solid #00002E;height: 50px!important; "><!--header  -->
                ...
                <td style="border: 2px solid #00002E;color: white;position: center">Tax Amount</td>
                <td style="border: 2px solid #00002E;color: white;position: center">Net</td>
                <td style="border: 2px solid #00002E;color: white;position: center">Reason</td>
            ...
            <tr>
                ...
                <td style="border: 2px solid #00002E" >{{ $pending->TaxAmount}}</td>
                <td style="border: 2px solid #00002E" >{{ $pending->net}}</td>
                <td style="border: 2px solid #00002E" >{{ $pending->Reason}}</td>
                <td style="border: 2px solid #00002E" >{{ $pending->User}}</td>

                <td ><a id="pre" href='printbroker/{{$pending ->id}}' class="btn-primary">Print</a></td>
...
<center>
    <form  id="contact-form"   method="post">
        ...
        $pendingBroker =DB::select('select * from broker where status ="Approve" ORDER BY id DESC');
