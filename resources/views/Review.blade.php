    ...
    <form  id="contact-form"   method="post">
        ...
        <table class="table_data" cellspacing="5" id="tab">
            ...
            <tr>
                <td></td><td></td>
                <td>
                    <button id="pre" type="submit" formaction="/financeapprov/{{$policy[0]->id }}" style="width:100px;  border-radius: 10px ;color: white; background-color: #002752; border: 1px solid #00002E;">Review</button>
                </td>
            </tr>
