...
<head>
    ...
    <style>
        ...
        /* css of print policy button  after put pointer on it  */
...
<!--layout for any employee or cashier to print  -->
<br><br>
...
<table class="table table-sm table-primary">
    ...
    $policies = DB::select('select * from policies where FinanceStatus = "Review" and Cashier is not null ORDER BY id DESC');
